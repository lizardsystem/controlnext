...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('controlnext_growerinfo', 'jdbc_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsjdbc.JdbcSource'], null=True, blank=True), keep_default=False)
