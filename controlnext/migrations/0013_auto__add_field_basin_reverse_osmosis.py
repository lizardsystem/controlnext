...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basin.reverse_osmosis'
        db.add_column('controlnext_basin', 'reverse_osmosis',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basin.reverse_osmosis'
        db.delete_column('controlnext_basin', 'reverse_osmosis')
