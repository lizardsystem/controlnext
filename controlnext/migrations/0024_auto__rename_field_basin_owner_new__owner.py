...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('controlnext_basin', 'owner_new', 'owner')


    def backwards(self, orm):
        # Adding field 'Basin.owner_new'
        db.rename_column('controlnext_basin', 'owner', 'owner_new')
    ...
    models = {
        ...
        'controlnext.basin': {
            ...
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'4c8d5teahxkujw4m42fp'", 'unique': 'True', 'max_length': '20'}),
        ...
        'controlnext.growerinfo': {
            ...
            'rain_flood_surface': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rain_location_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'ufn4am6vcpj351amlchz'", 'unique': 'True', 'max_length': '20'})
        },
