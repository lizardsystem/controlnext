...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basin.owner'
        db.add_column('controlnext_basin', 'owner',
        ...
        # Changing field 'UserProfile.owner'
        db.alter_column('controlnext_userprofile', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['controlnext.GrowerInfo']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WaterDemand.owner'
        ...
        # Changing field 'UserProfile.owner'
        db.alter_column('controlnext_userprofile', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['controlnext.GrowerInfo'], null=True))
    ...
    models = {
        ...
        'controlnext.growerinfo': {
            ...
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'3sy0jt488eez9pjwbtty'", 'unique': 'True', 'max_length': '20'})
        },
