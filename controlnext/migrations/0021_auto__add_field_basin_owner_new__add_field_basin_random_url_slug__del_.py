...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basin.owner_new'
        db.add_column('controlnext_basin', 'owner_new',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Basin.random_url_slug'
        db.add_column('controlnext_basin', 'random_url_slug',
                      self.gf('django.db.models.fields.CharField')(default=u'vyaj4a8qy4iqybv5i3y6', max_length=20),
                      keep_default=False)
        ...
        # Deleting field 'UserProfile.grower_id'
        db.delete_column('controlnext_userprofile', 'grower_id_id')

        # Adding field 'UserProfile.basin'
        db.add_column('controlnext_userprofile', 'basin',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['controlnext.Basin']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basin.owner_new'
        db.delete_column('controlnext_basin', 'owner_new')

        # Deleting field 'Basin.random_url_slug'
        db.delete_column('controlnext_basin', 'random_url_slug')

        # Adding field 'UserProfile.grower_id'
        db.add_column('controlnext_userprofile', 'grower_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12345123451234512345L, to=orm['controlnext.GrowerInfo']),
                      keep_default=False)

        # Deleting field 'UserProfile.basin'
        db.delete_column('controlnext_userprofile', 'basin_id')
    ...
    models = {
        ...
        'controlnext.basin': {
            ...
            'owner_new': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'ddma5xssmw8ocyaxsejd'", 'max_length': '20'}),
        ...
        'controlnext.growerinfo': {
            ...
            'rain_flood_surface': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rain_location_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'vvd8as1jygb7b3r0qqtj'", 'unique': 'True', 'max_length': '20'})
        },
