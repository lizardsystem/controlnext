...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Basin.owner'
        db.alter_column('controlnext_basin', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['controlnext.GrowerInfo']))

        # Datamigration
        for record in orm['controlnext.waterdemand'].objects.all():
            basin_id = record.basin.id
            record.owner = orm['controlnext.basin'].objects.get(id=basin_id).owner
            record.save()


    def backwards(self, orm):
        # Adding field 'Basin.owner_old'
        db.add_column('controlnext_basin', 'owner_old',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Basin.owner'
        db.alter_column('controlnext_basin', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['controlnext.GrowerInfo'], null=True))
    ...
    models = {
        ...
        'controlnext.growerinfo': {
            ...
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'hr7li07wywn916rbo7mb'", 'unique': 'True', 'max_length': '20'})
        },
