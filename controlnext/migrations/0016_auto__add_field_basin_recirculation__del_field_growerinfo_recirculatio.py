...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basin.recirculation'
        db.add_column('controlnext_basin', 'recirculation',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'GrowerInfo.recirculation'
        db.delete_column('controlnext_growerinfo', 'recirculation')


    def backwards(self, orm):
        # Deleting field 'Basin.recirculation'
        db.delete_column('controlnext_basin', 'recirculation')

        # Adding field 'GrowerInfo.recirculation'
        db.add_column('controlnext_growerinfo', 'recirculation',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)
