...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Basin.owner'
        db.delete_column('controlnext_basin', 'owner_id')

        # Deleting field 'WaterDemand.owner'
        db.delete_column('controlnext_waterdemand', 'owner_id')


        # Changing field 'WaterDemand.basin'
        db.alter_column('controlnext_waterdemand', 'basin_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['controlnext.Basin']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Basin.owner'
        raise RuntimeError("Cannot reverse this migration. 'Basin.owner' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'WaterDemand.owner'
        raise RuntimeError("Cannot reverse this migration. 'WaterDemand.owner' and its values cannot be restored.")

        # Changing field 'WaterDemand.basin'
        db.alter_column('controlnext_waterdemand', 'basin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['controlnext.Basin'], null=True))
    ...
    models = {
        ...
        'controlnext.basin': {
            ...
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'rysv0ktw8igx0dxgorrd'", 'unique': 'True', 'max_length': '20'}),
        ...
        'controlnext.growerinfo': {
            ...
            'rain_flood_surface': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rain_location_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'random_url_slug': ('django.db.models.fields.CharField', [], {'default': "u'2tyvjyqmc21koudxwl0l'", 'unique': 'True', 'max_length': '20'})
        },
