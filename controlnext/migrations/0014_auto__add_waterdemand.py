...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WaterDemand'
        db.create_table('controlnext_waterdemand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('daynumber', self.gf('django.db.models.fields.IntegerField')()),
            ('weeknumber', self.gf('django.db.models.fields.IntegerField')()),
            ('demand', self.gf('django.db.models.fields.FloatField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['controlnext.GrowerInfo'])),
        ))
        db.send_create_signal('controlnext', ['WaterDemand'])


    def backwards(self, orm):
        # Deleting model 'WaterDemand'
        db.delete_table('controlnext_waterdemand')
